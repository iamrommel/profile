...
export let TechUsed = () => {
  return (
    <div className="row">
      ...
      <Image name="do" title="DigitalOcean: Helping millions of developers easily build, test, manage, and scale applications of any size – faster than ever before."/>
      <Image name="expoio" title="Expo: The fastest way to build an app"/>
      <Image name="express" title="Express: Express.js: the fast, unopinionated, minimalist web framework for node"/>
      <Image name="graphql" title="Graphql: a query language for APIs and a runtime for fulfilling those queries with your existing data."/>
      ...
      <Image name="ios" title="iOS (formerly iPhone OS): a mobile operating system created and developed by Apple Inc. "/>
    </div>
  )

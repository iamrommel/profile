      ...
      <div className="container">
        <div className="my-5">
          ...
          <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the
            https://lsf.ph
            website (the "Service") operated by Rommel C. Manalo Profile ("us", "we", or "our").</p>
          ...
          <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of
            the terms
            then you may not access the Service. This Terms and Conditions agreement for Rommel C. Manalo Profile is
            managed by
          ...
          <p>Rommel C. Manalo Profile has no control over, and assumes no responsibility for, the content, privacy
            policies, or
            practices of any third party web sites or services. You further acknowledge and agree that Rommel C. Manalo
            Profile
          ...
          <p>These Terms shall be governed and construed in accordance with the laws of Philippines, without regard to
            its
          ...
          <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision
            is material
            we will try to provide at least 30 days notice prior to any new terms taking effect. What constitutes a
            material
